...
#include <mllm/models/qwen3/modeling_qwen3_topk.hpp>
...
MLLM_MAIN({
  ...
  auto& perf_path = Argparse::add<std::string>("--perf_path").help("Perfetto trace output path").def("qwen3_topk.perf");
...

  {
    ...
    fmt::print("\n{:*^60}\n", " Qwen3 Top-K Sparse Attention Interactive CLI ");
